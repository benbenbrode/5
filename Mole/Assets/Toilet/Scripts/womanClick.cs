...
public class womanClick : MonoBehaviour
{
    ...
    public Button womanb;
    // Start is called before the first frame update
    void Start()
    {
        womanb = GameObject.Find("woman").GetComponent<Button>();
    ...
    IEnumerator Moving()
    {
        ...
        first = true;
        target = GameObject.Find((GameObject.Find("Canvas").GetComponent<people>().cnt).ToString());
        GameObject.Find("man").GetComponent<manClick>().target = GameObject.Find((GameObject.Find("Canvas").GetComponent<people>().cnt).ToString());
        yield break;
    }
}
