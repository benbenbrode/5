...
public class card2bt : MonoBehaviour
{
    public GameObject x;
    public GameObject o;
    ...
    public void OnClick()
    {
        ...
        {
            if (GameObject.Find("EventSystem").GetComponent<mix>().jokercker == 2)
            {
            ...
            else if (GameObject.Find("EventSystem").GetComponent<mix>().jokercker == 1)
            {
                GameObject.Find("Canvas").GetComponent<rocktimer>().gameclearck = 1;
